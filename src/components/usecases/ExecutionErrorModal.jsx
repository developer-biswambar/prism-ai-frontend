                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                ...
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                    ...
                                    <div className="space-y-1">
                                        {errorData.error_analysis.missing_columns.map(column => (
                                            <span key={column} className="inline-block bg-red-100 text-red-800 text-xs px-2 py-1 rounded mr-2">
                                                {column}
                                            </span>
                                        ))}
                                    </div>
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                    ...
                                    <div className="space-y-1">
                                        {errorData.error_analysis.available_columns.map(column => (
                                            <span key={column} className="inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded mr-2">
                                                {column}
                                            </span>
                                        ))}
                                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        {errorData.available_options && errorData.available_options.map(option => (
                            ...
                            >
                                <div className="flex items-start space-x-3">
                                    {option.option === 'ai_assisted' && <Brain className="text-blue-500 flex-shrink-0 mt-0.5" size={20} />}
                                    {option.option === 'column_mapping' && <Settings className="text-purple-500 flex-shrink-0 mt-0.5" size={20} />}
                                    {option.option === 'cancel' && <XCircle className="text-gray-500 flex-shrink-0 mt-0.5" size={20} />}
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {option.option === 'ai_assisted' && (
                                            <div className="mt-2 p-2 bg-blue-100 border border-blue-200 rounded text-xs text-blue-800">
                                                <strong>Note:</strong> AI will analyze your data and adapt the query automatically. 
