...
import {CheckCircle, Clock, Eye, FileText, Loader, Play, Star, Trash2} from 'lucide-react';
...
const UseCaseCard = ({
    ...
    return (
        <div
            className={`relative group bg-white rounded-xl border-2 transition-all duration-300 ease-in-out overflow-hidden h-[280px] flex flex-col ${
                isSelected
                    ? 'border-blue-500 shadow-xl shadow-blue-200/40 ring-2 ring-blue-200/30 bg-blue-50/30'
                    : 'border-gray-150 hover:border-blue-200 hover:shadow-lg hover:shadow-gray-100/50'
            }`}
        ...
        >
            ...
            <div className="p-4 flex-1 flex flex-col">
                <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-3 mb-2">
                            <div
                                className="w-8 h-8 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center">
                        ...
                        <div className="flex items-center space-x-1 mb-2 flex-wrap">
                            ...
                            {useCase?.use_case_metadata?.file_requirements?.required_file_count > 0 && (
                                <span
                                    className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800 border-amber-200">
                ...
                {/* Description */}
                <p className="text-xs text-gray-600 line-clamp-2 mb-2 flex-1 px-4">
                    {useCase?.description || 'No description available'}
                </p>

                {/* Stats row */}
                <div className="flex items-center justify-end text-xs text-gray-500 mb-2 px-4">
                    <div className="flex items-center space-x-1">
                        <Clock size={10}/>
            ...
            {/* All Action Buttons - Always at bottom right, horizontal layout */}
            <div className="p-3 mt-auto flex justify-between" style={{zIndex: 20}}>
                ...
                <div>
                    {isSelected && onDelete && (
                        <button
                            ...
                            className="px-3 py-2 rounded-md text-xs font-medium bg-red-100 text-red-700 hover:bg-red-200 border border-red-200 transition-colors shadow-sm"
                            style={{zIndex: 40}}
                        >
                            <div className="flex items-center space-x-1">
                                <Trash2 size={10}/>
                ...
                {/* View and Apply Buttons - Right Side */}
                <div className="flex items-center space-x-2">
                    ...
                    {isSelected && onView && (
                        <button
                            ...
                            className="px-3 py-2 rounded-md text-xs font-medium bg-blue-100 text-blue-700 hover:bg-blue-200 border border-blue-200 transition-colors shadow-sm"
                            style={{zIndex: 40}}
                        >
                            <div className="flex items-center space-x-1">
                                <Eye size={10}/>
                    ...
                    {onApply && (
                        <button
                            ...
                            disabled={isLoading}
                            className={`px-4 py-2 rounded-md text-xs font-medium transition-colors shadow-sm ${
                                isLoading
