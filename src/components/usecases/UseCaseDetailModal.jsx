    ...
    const renderStars = (rating, ratingCount) => {
        ...
        return (
            <div className="flex items-center space-x-1">
                ...
                {ratingCount > 0 && (
                    <span
                        className="text-sm text-gray-500 ml-2">({ratingCount} rating{ratingCount !== 1 ? 's' : ''})</span>
                )}
            </div>
        );
    };
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getUseCaseTypeColor(useCase.use_case_type)}`}>
            ...
            {useCase.use_case_content && (
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                    ...
                    <div className="bg-white p-4 rounded-lg">
                        <pre
                            className="whitespace-pre-wrap text-sm text-gray-800 font-mono">{useCase.use_case_content}</pre>
                    </div>
                </div>
            )}
                    ...
                    {(useCase.use_case_metadata.original_prompt || useCase.use_case_metadata.ideal_prompt) && (
                        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                            ...
                            {useCase.use_case_metadata.original_prompt && (
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-blue-700 mb-2">Original
                                        Prompt</label>
                            ...
                            {useCase.use_case_metadata.ideal_prompt && (
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-blue-700 mb-2">AI-Optimized
                                        Prompt</label>
                                    <div className="bg-white p-3 rounded-lg">
                            ...
                            {useCase.use_case_metadata.improvements_made && (
                                <div>
                                    <label className="block text-sm font-medium text-blue-700 mb-2">AI
                                        Improvements</label>
                                    <div className="bg-white p-3 rounded-lg">
                    ...
                    {useCase.use_case_metadata.processing_context && (
                        <div className="bg-white p-6 rounded-lg border border-gray-200">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Smart
                                        Execution</label>
                                    <p className="text-gray-900">
                            ...
                            {useCase.use_case_metadata.processing_context.generated_sql && (
                                <div className="mt-4">
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Generated
                                        SQL</label>
                ...
                {useCase.use_case_metadata?.success_metrics && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="flex items-center space-x-2">
                            <CheckCircle
                                className={`${useCase.use_case_metadata.success_metrics.has_results ? 'text-green-500' : 'text-gray-300'}`}
                                size={16}/>
                        ...
                        <div className="flex items-center space-x-2">
                            <CheckCircle
                                className={`${useCase.use_case_metadata.success_metrics.execution_success ? 'text-green-500' : 'text-gray-300'}`}
                                size={16}/>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span
                                className="text-sm">Process ID: {useCase.use_case_metadata.success_metrics.process_id || 'N/A'}</span>
                        </div>
                    </div>
                )}
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span
                                className="text-sm text-gray-600">{Math.min(((useCase.usage_count || 0) / 10) * 100, 100).toFixed(0)}%</span>
                        </div>
                    </div>
                </div>
            </div>
