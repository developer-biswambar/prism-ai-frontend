...
const EnhancedIntentVerificationModal = ({ 
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-blue-800">
                <strong>Tip:</strong> Our AI will suggest alternative column names if your references don't match exactly.
              </div>
            </div>
          </div>
        </div>
  ...
  const getFeasibilityColor = (score) => {
    if (score >= 0.8) return { bg: 'bg-green-50', border: 'border-green-200', text: 'text-green-800', icon: 'text-green-600' };
    if (score >= 0.6) return { bg: 'bg-yellow-50', border: 'border-yellow-200', text: 'text-yellow-800', icon: 'text-yellow-600' };
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <div className={`w-3 h-3 rounded-full ${successRate === 1 ? 'bg-green-500' : successRate > 0.5 ? 'bg-yellow-500' : 'bg-red-500'}`}></div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <p className="text-sm text-purple-800 mb-4">
            AI found similar columns that might match what you're looking for. Select the ones you want to use:
          </p>
              ...
              <div key={index} className="bg-white border border-purple-200 rounded-lg p-3">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    ...
                    <span className="text-red-600 font-mono text-sm">{suggestion.missing_column}</span>
                  </div>
                    ...
                    <div key={sugIndex} className="border border-gray-200 rounded p-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ml-4 text-right">
                          ...
                          <div className="font-medium text-sm">{Math.round(sug.confidence * 100)}%</div>
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 mt-1">AI-powered feasibility analysis with intelligent suggestions</p>
            </div>
            <div className={`px-4 py-2 rounded-full text-sm font-medium ${feasibilityColors.bg} ${feasibilityColors.text} border ${feasibilityColors.border}`}>
